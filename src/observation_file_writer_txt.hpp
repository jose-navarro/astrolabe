/** \file observation_file_writer_txt.hpp
  \brief Class defining the interface of observation text file writers.
  \ingroup ASTROLABE_data_IO
*/

#ifndef OBSERVATION_FILE_WRITER_TXT_HPP
#define OBSERVATION_FILE_WRITER_TXT_HPP
 ...
 *
 */
class observation_file_writer_txt : public obs_e_based_file_writer_txt
{
  public:
     ...
     *
     */
                 observation_file_writer_txt (void);
     ...
     */
    virtual     ~observation_file_writer_txt (void);
...
#endif // OBSERVATION_FILE_WRITER_TXT_HPP
