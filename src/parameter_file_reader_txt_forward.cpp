/** \file parameter_file_reader_txt_forward.cpp 
  \brief Implementation file for parameter_file_reader_txt_forward.hpp.
...
{
  {
    ...
    //
    // o-records do not exist in parameter files. We return invalid
