/** \file instrument_file_reader_txt_forward.cpp 
  \brief Implementation file for instrument_file_reader_txt_forward.hpp.
...
{
  {
    ...
    //
    // o-records do not exist in instrument files. We return invalid
...
{
  {
    ...
    //
    // Epoch have no meaning in instrument files. However,
    // we keep the epoch detection code here to avoid possible
    // collateral effects with methods included in ascendant
    // classes.
    //
