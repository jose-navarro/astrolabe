/** \file obs_residuals_file_reader_bin_forward.cpp 
  \brief Implementation file for obs_residuals_file_reader_bin_forward.hpp
...
{
  {
    ...
    //
    // o-records do not exist in ASTROLABE observation residuals files. Just return
