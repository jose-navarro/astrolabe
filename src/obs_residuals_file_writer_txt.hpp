/** \file obs_residuals_file_writer_txt.hpp
  \brief Class defining the interface of ASTROLABE observation residuals text file writers.
  \ingroup ASTROLABE_data_IO
*/

#ifndef OBS_RESIDUALS_FILE_WRITER_TXT_HPP
#define OBS_RESIDUALS_FILE_WRITER_TXT_HPP
 ...
 *
 */
class obs_residuals_file_writer_txt : public obs_e_based_file_writer_txt
{
  public:
     ...
     */
                 obs_residuals_file_writer_txt (void);

    /**
     * @brief Destructor.
     */
    virtual     ~obs_residuals_file_writer_txt (void);
...
#endif // OBS_RESIDUALS_FILE_WRITER_TXT_HPP
