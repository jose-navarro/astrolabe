/** \file obs_e_based_file_writer.cpp 
  \brief Implementation file for obs_e_based_file_writer.hpp.
  \ingroup ASTROLABE_data_IO 
*/ 
#include "obs_e_based_file_writer.hpp"

int
obs_e_based_file_writer::
_buffer_size
(void)
const
{
...
{
  {
    return _ASTROLABE_FILE_WRITER_DEFAULT_BUFFER_SIZE ;
  }
}
...
{
  {
    data_buffer_         = NULL;
    data_buffer_cur_     = 0;
    data_buffer_size_    = _ASTROLABE_FILE_WRITER_DEFAULT_BUFFER_SIZE;
    file_file_           = NULL;
    file_name_           = NULL;
    file_is_open_        = false;
