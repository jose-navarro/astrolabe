/** \file parameter_file_reader_txt_forward.hpp
  \brief Class defining the interface of forward text parameter file readers.
  \ingroup ASTROLABE_data_IO
*/

#ifndef PARAMETER_FILE_READER_TXT_FORWARD_HPP
#define PARAMETER_FILE_READER_TXT_FORWARD_HPP
 ...
 * astrolabe_file_reader_txt_forward, reading parameter files stored in text format in
 * forward direction.
 *
 */

class parameter_file_reader_txt_forward : public obs_e_based_file_reader_txt_forward
{
  public:
     ...
     */
                 ...
                 parameter_file_reader_txt_forward  (void);
     ...
     * there exist no o-records in parameter files.
     *
...
#endif // PARAMETER_FILE_READER_TXT_FORWARD_HPP
