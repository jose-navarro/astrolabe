/** \file parameter_file_writer_bin.hpp
  \brief Class defining the interface of binary parameter file writers.
  \ingroup ASTROLABE_data_IO
*/

#ifndef PARAMETER_FILE_WRITER_BIN_HPP
#define PARAMETER_FILE_WRITER_BIN_HPP
 ...
 *
 */
class parameter_file_writer_bin : public obs_e_based_file_writer_bin
{
  public:
     ...
     *
     */
                 parameter_file_writer_bin (void);

    /**
     * @brief Destructor.
     */
    virtual     ~parameter_file_writer_bin (void);
...
#endif // PARAMETER_FILE_WRITER_BIN_HPP
