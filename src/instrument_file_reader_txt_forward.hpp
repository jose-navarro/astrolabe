/** \file instrument_file_reader_txt_forward.hpp
  \brief Class defining the interface of forward text instrument file readers.
  \ingroup ASTROLABE_data_IO
*/

#ifndef INSTRUMENT_FILE_READER_TXT_FORWARD_HPP
#define INSTRUMENT_FILE_READER_TXT_FORWARD_HPP
 ...
 * astrolabe_file_reader_txt_forward, reading instrument files stored in text format in
 * forward direction.
 *
 */

class instrument_file_reader_txt_forward : public obs_e_based_file_reader_txt_forward
{
  public:
     ...
     */
                 ...
                 instrument_file_reader_txt_forward  (void);
     ...
     *
     * However, ASTROLABE instrument files DO NOT INCLUDE o-records. Therefore,
     ...
     * there exist no o-records in instrument files.
     *
...
#endif // INSTRUMENT_FILE_READER_TXT_FORWARD_HPP
