/** \file obs_residuals_writer.hpp
  \brief  Class able to write observation residuals data to all kinds of
          ASTROLABE supported data channels.
  \ingroup ASTROLABE_data_IO
*/

#ifndef OBS_RESIDUALS_WRITER_HPP
#define OBS_RESIDUALS_WRITER_HPP
...
/**
   ...
   This includes both text and binary files.

   THIS IS THE CLASS TO USE WHEN WRITING ASTROLABE OBSERVATION RESIDUALS DATA. All other
   ...
   - Set the kind of output channel using set_data_channel().
...
class obs_residuals_writer
{
  public:

    /**
     * \brief Closes the observation residuals writer, disabling any other
     ...
     * method set_data_channel(), it is possible to open
     ...
     *
     * After an observation residuals writer has been instantiated, the parameters defining the
     * type of data channel used must be specified.
     *
     * This methods sets the output channel as a file.
     *
...
#endif // OBS_RESIDUALS_WRITER_HPP
