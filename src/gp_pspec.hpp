/** \file gp_pspec.hpp
  \brief Entity class to hold the \<p_spec\> element in
         ASTROLABE metadata files.
  \ingroup ASTROLABE_metadata
*/

#ifndef _GP_PSPEC_HPP_
#define _GP_PSPEC_HPP_
...
/// \brief Entity class to hold the \<p_spec\> element in ASTROLABE metadata files.
/**
  A gp_pspec object is composed of several members. Some of these (gp_covariance,
  gp_timespec, gp_ref, gp_scale, gp_unit and gp_tspec) are also objects on their own that
  are AUTOMATICALLY created when instantiating a gp_pspec object.
  ...
  included in the gp_pspec object must be done (a) getting a pointer
  to the sub-object that must be changed and (b) calling the specific methods
  provided by the sub-object to do so.

  For instance, to modify the gp_unit member of a gp_pspec object, the
  ...
  gp_unit*  my_unit;
  ...
  // Get a pointer to my_pspec's internal units object.
  my_unit = my_pspec->get_unit_ptr();
  ...
  // sub-object included in my_pspec.
  ...
  \endcode

  The gp_unit included in the gp_pspec object is directly modified in
  ...
  the object thus retrieved. Doing so, would corrupt the gp_pspec object
...
class gp_pspec
{
  public:
    ...
    /// \brief Check if the \<p_spec\> element is active (s attribute).
    /**
      \return True if the \<p_spec\> is active (s attribute value "a")
    ...
    */
    ...
    /**
      ...
      gp_pspec object and this could crash the application.
    */

    gp_covariance* get_covariance_ptr (void);

    /// \brief Retrieve the dimension (element \<dimension\>) of the gp_pspec object.
    /**
    ...
    */
    ...
    /// \brief Retrieve the toolbox (element \<toolbox\>) of the gp_pspec object.
    /**
    ...
    */
    ...
    /// \brief Retrieve the type (element \<type\>) of the gp_pspec object.
    /**
    ...
    */
    ...
    /// \brief Set the active flag (s attribute) of the \<p_spec\> element.
    /**
      \param active The active flag. Set it to true to state that the
             \<p_spec\> element is active, false otherwise.
    */

    void           set_active         (bool active);

    /// \brief Set the dimension (element \<dimension\>) of the gp_pspec object.
    /**
      \pre (dimension > 0)
    ...
    */
    ...
    /// \brief Set the toolbox (element \<toolbox\>) of the gp_pspec object.
    /**
      \pre (!toolbox.empty())
      \throw astrolabe_precondition_violation One or more preconditions have
             been violated.
    ...
    */
    ...
    /// \brief Set the type (element \<type\>) of the gp_pspec object.
    /**
      \pre (!type.empty())
      \throw astrolabe_precondition_violation One or more preconditions have
             been violated.
