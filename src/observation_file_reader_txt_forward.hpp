/** \file observation_file_reader_txt_forward.hpp
  \brief Class defining the interface of forward observation text file readers.
  \ingroup ASTROLABE_data_IO
*/

#ifndef OBSERVATION_FILE_READER_TXT_FORWARD_HPP
#define OBSERVATION_FILE_READER_TXT_FORWARD_HPP
 ...
 * astrolabe_file_reader_txt, reading observation files stored in text format in
 * forward direction.
 *
 */

class observation_file_reader_txt_forward : public obs_e_based_file_reader_txt_forward
{
  public:
     ...
     */
                 ...
                 observation_file_reader_txt_forward  (void);
...
#endif // OBSERVATION_FILE_READER_TXT_FORWARD_HPP
