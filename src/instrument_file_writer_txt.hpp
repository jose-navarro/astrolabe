/** \file instrument_file_writer_txt.hpp
  \brief Class defining the interface of ASTROLABE instrument text file writers.
  \ingroup ASTROLABE_data_IO
*/

#ifndef INSTRUMENT_FILE_WRITER_TXT_HPP
#define INSTRUMENT_FILE_WRITER_TXT_HPP
 ...
 *
 */
class instrument_file_writer_txt : public obs_e_based_file_writer_txt
{
  public:
     ...
     */
                 instrument_file_writer_txt (void);

    /**
     * @brief Destructor.
     */
    virtual     ~instrument_file_writer_txt (void);
...
#endif // INSTRUMENT_FILE_WRITER_TXT_HPP
