/** \file obs_residuals_file_reader_bin_forward.hpp
  \brief Class defining the interface of forward binary observation residuals file readers.
  \ingroup ASTROLABE_data_IO
*/

#ifndef OBS_RESIDUALS_FILE_READER_BIN_FORWARD_HPP
#define OBS_RESIDUALS_FILE_READER_BIN_FORWARD_HPP
 ...
 * obs_e_based_file_reader_bin_forward, reading observation residuals files stored in binary format in
 * forward direction.
 *
 */

class obs_residuals_file_reader_bin_forward : public obs_e_based_file_reader_bin_forward
{
  public:
     ...
     */
                 ...
                 obs_residuals_file_reader_bin_forward  (void);
     ...
     *        observation residuals, it must always be a lowercase 'l' (there are no 'o'
     *        records.
     * @return Error code. Error code values:
     *         - 0: Successful completion.
     *         - 1: End-of-file (no more data).
     ...
     * an 'l' character (always lowercase) denoting the type of record
     * being read (l-records only).
     *
     */
...
#endif // OBS_RESIDUALS_FILE_READER_BIN_FORWARD_HPP
