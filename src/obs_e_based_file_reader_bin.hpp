/** \file obs_e_based_file_reader_bin.hpp
  \brief Abstract class to define the interface of binary obs_e_based file readers.
  \ingroup ASTROLABE_data_IO
*/

#ifndef OBS_E_BASED_FILE_READER_BIN_HPP
#define OBS_E_BASED_FILE_READER_BIN_HPP
 ...
 * obs_e_based_file_reader, reading obs_e_based files stored in binary format.
 *
 */
class obs_e_based_file_reader_bin : public obs_e_based_file_reader
{
  public:
     ...
     */
                 ...
                 obs_e_based_file_reader_bin  (void);
    ...
    virtual      ~obs_e_based_file_reader_bin (void);
     ...
     *
     * However, this method is not implemented in this base class. See
     * the documentation in the respective descendant classes for further,
     * specific details.
     */
...
#endif // OBS_E_BASED_FILE_READER_BIN_HPP
